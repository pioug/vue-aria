...
- Package: `@vue-aria/color`
- Upstream reference: `packages/@react-aria/color` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/event semantics (`useState`, `useRef`, `useCallback`, `useMemo`, React pointer/mouse/touch/input event typing) across color area/slider/wheel/field interactions.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
...
- Package: `@vue-aria/table`
- Upstream reference: `packages/@react-aria/table` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/event semantics (`useMemo`, `useEffect`, `useRef`, `useCallback`, React change/keyboard typing) together with inherited React-based grid/selection interaction behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
...
- Package: `@vue-aria/dialog`
- Upstream reference: `packages/@react-aria/dialog` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime semantics (`useEffect`, `useRef`) and inherited React-based overlay focus containment behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential dialog focus handoff timing differences until full composable conversion.
- Removal plan: Replace React hook/runtime assumptions and inherited overlay focus handling with Vue-native composables and port upstream dialog behavior tests for parity.

- Package: `@vue-aria/menu`
- Upstream reference: `packages/@react-aria/menu` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/event semantics (`useRef`, `useState`, `useEffect`, `useLayoutEffect`, React mouse/pointer typing) together with inherited React-based selection/overlay interaction behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
...
- Package: `@vue-aria/combobox`
- Upstream reference: `packages/@react-aria/combobox` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/event semantics (`useState`, `useEffect`, `useMemo`, `useRef`, React focus/keyboard/touch/input typing) together with inherited React-based menu/selection/textfield integration behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential combobox open/selection/announcement timing differences until full composable conversion.
- Removal plan: Replace React hook/event/runtime assumptions and inherited interaction flows with Vue-native composables/event typing and port upstream combobox behavior tests for parity.

- Package: `@vue-aria/autocomplete`
- Upstream reference: `packages/@react-aria/autocomplete` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/event semantics (`useState`, `useEffect`, `useLayoutEffect`, `useMemo`, `useRef`, React focus/keyboard typing) together with inherited React-based combobox/searchfield integration behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential autocomplete focus/active-descendant/filter timing differences until full composable conversion.
- Removal plan: Replace React hook/event/runtime assumptions and inherited integration flows with Vue-native composables/event typing and port upstream autocomplete behavior tests for parity.

- Package: `@vue-aria/dnd`
- Upstream reference: `packages/@react-aria/dnd` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/event/rendering semantics (`useState`, `useEffect`, `useLayoutEffect`, `useMemo`, `useRef`, `useImperativeHandle`, `forwardRef`, React drag/pointer/focus typing) across drag/drop and keyboard drag workflows.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
...
- Package: `@vue-spectrum/filetrigger`
- Upstream reference: `packages/@react-spectrum/filetrigger` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/render semantics together with inherited React-based button/file-input interaction behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
...
- Package: `@vue-spectrum/avatar`
- Upstream reference: `packages/@react-spectrum/avatar` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum styling/interaction layers.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential avatar render/update timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream avatar behavior tests for parity.

- Package: `@vue-spectrum/buttongroup`
- Upstream reference: `packages/@react-spectrum/buttongroup` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum button/layout behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential button group layout/interaction timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream buttongroup behavior tests for parity.

- Package: `@vue-spectrum/switch`
- Upstream reference: `packages/@react-spectrum/switch` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React-based switch interaction/state behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential switch interaction/focus timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream switch behavior tests for parity.

- Package: `@vue-spectrum/link`
- Upstream reference: `packages/@react-spectrum/link` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React-based link interaction behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential link interaction/focus timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream link behavior tests for parity.

- Package: `@vue-spectrum/image`
- Upstream reference: `packages/@react-spectrum/image` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React-based image loading/styling behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential image render/loading timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream image behavior tests for parity.

- Package: `@vue-spectrum/statuslight`
- Upstream reference: `packages/@react-spectrum/statuslight` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum status styling behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential status light render/update timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream statuslight behavior tests for parity.

- Package: `@vue-spectrum/accordion`
- Upstream reference: `packages/@react-spectrum/accordion` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React-based disclosure/accordion interaction behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential accordion expand/collapse timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream accordion behavior tests for parity.

- Package: `@vue-spectrum/form`
- Upstream reference: `packages/@react-spectrum/form` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React-based form field layout/validation presentation behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
...
- Package: `@vue-spectrum/text`
- Upstream reference: `packages/@react-spectrum/text` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum text/context styling behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential text/context render timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream text behavior tests for parity.

- Package: `@vue-spectrum/view`
- Upstream reference: `packages/@react-spectrum/view` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum style props/layout behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential view layout/style resolution timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream view behavior tests for parity.

- Package: `@vue-spectrum/badge`
- Upstream reference: `packages/@react-spectrum/badge` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum badge styling behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential badge render/styling timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream badge behavior tests for parity.

- Package: `@vue-spectrum/progress`
- Upstream reference: `packages/@react-spectrum/progress` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum progress visualization behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential progress render/announcement timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream progress behavior tests for parity.

- Package: `@vue-spectrum/meter`
- Upstream reference: `packages/@react-spectrum/meter` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum meter visualization behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential meter render/announcement timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream meter behavior tests for parity.

- Package: `@vue-spectrum/layout`
- Upstream reference: `packages/@react-spectrum/layout` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum layout primitive behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential layout primitive render timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream layout behavior tests for parity.

- Package: `@vue-spectrum/illustratedmessage`
- Upstream reference: `packages/@react-spectrum/illustratedmessage` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum illustrated-message styling behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential illustrated message render/styling timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream illustratedmessage behavior tests for parity.

- Package: `@vue-spectrum/overlays`
- Upstream reference: `packages/@react-spectrum/overlays` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React-based overlay/dialog positioning/focus behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential overlay layering/focus timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream overlays behavior tests for parity.

- Package: `@vue-spectrum/tooltip`
- Upstream reference: `packages/@react-spectrum/tooltip` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React-based tooltip overlay/timing behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential tooltip trigger/display timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream tooltip behavior tests for parity.

- Package: `@vue-spectrum/inlinealert`
- Upstream reference: `packages/@react-spectrum/inlinealert` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum alert/layout behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential inline alert render/announcement timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream inlinealert behavior tests for parity.

- Package: `@vue-spectrum/label`
- Upstream reference: `packages/@react-spectrum/label` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum label/context behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential label render/association timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream label behavior tests for parity.

- Package: `@vue-spectrum/labeledvalue`
- Upstream reference: `packages/@react-spectrum/labeledvalue` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum labeled value layout behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential labeled value render/layout timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream labeledvalue behavior tests for parity.

- Package: `@vue-spectrum/radio`
- Upstream reference: `packages/@react-spectrum/radio` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum radio-group interaction/styling behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential radio interaction/focus timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream radio behavior tests for parity.

- Package: `@vue-spectrum/checkbox`
- Upstream reference: `packages/@react-spectrum/checkbox` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum checkbox interaction/styling behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential checkbox interaction/focus timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream checkbox behavior tests for parity.

- Package: `@vue-spectrum/tree`
- Upstream reference: `packages/@react-spectrum/tree` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum tree/list interaction behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential tree interaction/focus timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream tree behavior tests for parity.

- Package: `@vue-spectrum/dropzone`
- Upstream reference: `packages/@react-spectrum/dropzone` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React-based drag-and-drop/dropzone interaction behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential dropzone interaction/announcement timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream dropzone behavior tests for parity.

- Package: `@vue-spectrum/steplist`
- Upstream reference: `packages/@react-spectrum/steplist` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum step-list interaction/styling behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential step-list interaction/render timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream steplist behavior tests for parity.

- Package: `@vue-spectrum/slider`
- Upstream reference: `packages/@react-spectrum/slider` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum slider interaction/layout behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential slider interaction/focus timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream slider behavior tests for parity.

- Package: `@vue-spectrum/listbox`
- Upstream reference: `packages/@react-spectrum/listbox` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum listbox selection/interaction behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential listbox interaction/focus timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream listbox behavior tests for parity.

- Package: `@vue-spectrum/textfield`
- Upstream reference: `packages/@react-spectrum/textfield` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum text-input/validation behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential textfield input/validation timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream textfield behavior tests for parity.

- Package: `@vue-spectrum/numberfield`
- Upstream reference: `packages/@react-spectrum/numberfield` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum numberfield input/stepper behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
...
- Package: `@vue-types/list`
- Upstream reference: `packages/@react-types/list` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still carries React-oriented type/runtime assumptions through upstream type shapes.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect upstream React-oriented type assumptions until full type-surface conversion.
- Removal plan: Replace remaining React-oriented type assumptions with Vue-native equivalents and port upstream list type tests for parity.

- Package: `@vue-spectrum/card`
- Upstream reference: `packages/@react-spectrum/card` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum card interaction/layout behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential card interaction/render timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream card behavior tests for parity.

- Package: `@vue-spectrum/button`
- Upstream reference: `packages/@react-spectrum/button` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum button interaction/styling behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential button interaction/focus timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream button behavior tests for parity.

- Package: `@vue-spectrum/searchfield`
- Upstream reference: `packages/@react-spectrum/searchfield` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum searchfield input/clear-button behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential search input/interaction timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream searchfield behavior tests for parity.

- Package: `@vue-spectrum/tag`
- Upstream reference: `packages/@react-spectrum/tag` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum tag/list interaction behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential tag interaction/focus timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream tag behavior tests for parity.

- Package: `@vue-spectrum/combobox`
- Upstream reference: `packages/@react-spectrum/combobox` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum combobox/listbox interaction behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential combobox input/selection timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream combobox behavior tests for parity.

- Package: `@vue-spectrum/autocomplete`
- Upstream reference: `packages/@react-spectrum/autocomplete` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum autocomplete/combobox interaction behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential autocomplete interaction/selection timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream autocomplete behavior tests for parity.

- Package: `@vue-spectrum/picker`
- Upstream reference: `packages/@react-spectrum/picker` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum picker/listbox/menu interaction behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential picker open/selection timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream picker behavior tests for parity.

- Package: `@vue-spectrum/tabs`
- Upstream reference: `packages/@react-spectrum/tabs` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum tabs selection/focus behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential tab focus/activation timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream tabs behavior tests for parity.

- Package: `@vue-spectrum/toast`
- Upstream reference: `packages/@react-spectrum/toast` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum toast region/item behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential toast display/dismiss timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream toast behavior tests for parity.

- Package: `@vue-spectrum/calendar`
- Upstream reference: `packages/@react-spectrum/calendar` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum calendar/date interaction behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential calendar interaction/focus timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream calendar behavior tests for parity.

- Package: `@vue-spectrum/dialog`
- Upstream reference: `packages/@react-spectrum/dialog` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum dialog/overlay interaction behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential dialog focus/open-close timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream dialog behavior tests for parity.

- Package: `@vue-spectrum/contextualhelp`
- Upstream reference: `packages/@react-spectrum/contextualhelp` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum trigger/popover/help interaction behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential contextual help trigger/overlay timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream contextualhelp behavior tests for parity.

- Package: `@vue-spectrum/datepicker`
- Upstream reference: `packages/@react-spectrum/datepicker` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum datepicker/calendar/field interaction behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential date input/popup interaction timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream datepicker behavior tests for parity.

- Package: `@vue-spectrum/menu`
- Upstream reference: `packages/@react-spectrum/menu` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum menu/trigger/overlay interaction behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential menu interaction/open-close timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream menu behavior tests for parity.

- Package: `@vue-spectrum/breadcrumbs`
- Upstream reference: `packages/@react-spectrum/breadcrumbs` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum breadcrumb navigation behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential breadcrumb interaction/render timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream breadcrumbs behavior tests for parity.

- Package: `@vue-spectrum/actiongroup`
- Upstream reference: `packages/@react-spectrum/actiongroup` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum action-group selection/keyboard behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
...
- Package: `@vue-spectrum/color`
- Upstream reference: `packages/@react-spectrum/color` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum color control/field behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential color interaction/render timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream color behavior tests for parity.

- Package: `@vue-spectrum/table`
- Upstream reference: `packages/@react-spectrum/table` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum table/grid interaction behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential table interaction/sorting/selection timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream table behavior tests for parity.

- Package: `@vue-spectrum/s2`
- Upstream reference: `packages/@react-spectrum/s2` at baseline `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
- Difference: Package is currently a structural mirror and still depends on React runtime/rendering semantics and inherited React Spectrum S2 component/theme behavior.
- Reason: The package was ported incrementally to preserve API/dependency parity with upstream while unblocking dependent packages.
- User impact: This package is transitional and not yet Vue-native; consumers should expect React runtime/type dependencies and potential S2 interaction/render timing differences until full composable conversion.
- Removal plan: Replace React runtime assumptions with Vue-native composables/rendering patterns and port upstream S2 behavior tests for parity.
