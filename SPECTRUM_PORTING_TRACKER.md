...
- Completed packages: `5 / 64`
- Remaining packages: `59`
...
- In progress baseline: `@react-spectrum/provider` (Provider component, alias hooks, and component-level tests now ported), `@react-spectrum/icon`, `@react-spectrum/utils`
