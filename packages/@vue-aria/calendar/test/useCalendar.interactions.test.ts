...
describe("useCalendar upstream interaction parity", () => {
  const keyboardCases: KeyboardCase[] = [
    ...
    {
      name: "3-day ArrowRight one step",
      defaultValue: new CalendarDate(2019, 6, 5),
      visibleDuration: { days: 3 },
      key: "ArrowRight",
      count: 1,
    ...
    {
      name: "1-week ArrowLeft one step",
      defaultValue: new CalendarDate(2019, 6, 5),
      visibleDuration: { weeks: 1 },
      key: "ArrowLeft",
      count: 1,
    ...
    {
      name: "1-week ArrowRight one step",
      defaultValue: new CalendarDate(2019, 6, 5),
      visibleDuration: { weeks: 1 },
      key: "ArrowRight",
      count: 1,
    ...
    {
      name: "1-week ArrowDown",
      defaultValue: new CalendarDate(2019, 6, 5),
      visibleDuration: { weeks: 1 },
      key: "ArrowDown",
      count: 1,
      expectedFocus: "2019-06-12",
      expectedRangeStart: "2019-06-09",
      expectedRangeEnd: "2019-06-15",
    },
    {
    ...
    {
      name: "2-week ArrowLeft one step",
      defaultValue: new CalendarDate(2019, 6, 5),
      visibleDuration: { weeks: 2 },
      key: "ArrowLeft",
      count: 1,
    ...
    {
      name: "2-week ArrowLeft four steps",
      defaultValue: new CalendarDate(2019, 6, 5),
      visibleDuration: { weeks: 2 },
      key: "ArrowLeft",
      count: 4,
      expectedFocus: "2019-06-01",
      expectedRangeStart: "2019-05-19",
      expectedRangeEnd: "2019-06-01",
    },
    {
      name: "2-week ArrowRight one step",
      defaultValue: new CalendarDate(2019, 6, 5),
      visibleDuration: { weeks: 2 },
      key: "ArrowRight",
      count: 1,
    ...
    {
      name: "2-week ArrowRight four steps",
      defaultValue: new CalendarDate(2019, 6, 5),
      visibleDuration: { weeks: 2 },
      key: "ArrowRight",
      count: 4,
