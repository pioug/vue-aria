...
import {getEventTarget, useEffectEvent, useEvent, useLayoutEffect, useObjectRef, useResizeObserver} from '@vue-aria/utils';
...
import {Rect, Size} from '@vue-stately/virtualizer';
