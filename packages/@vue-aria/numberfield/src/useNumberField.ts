...
import {chain, filterDOMProps, getActiveElement, getEventTarget, isAndroid, isIOS, isIPhone, mergeProps, useFormReset, useId} from '@vue-aria/utils';
import {
  type ClipboardEvent,
...
import {DOMAttributes, GroupDOMAttributes, TextInputDOMProps, ValidationResult} from '@vue-types/shared';
import {flushSync} from 'react-dom';
// @ts-ignore
import intlMessages from '../intl/*.json';
import {NumberFieldState} from '@vue-stately/numberfield';
import {privateValidationStateProp} from '@vue-stately/form';
import {useFocus, useFocusWithin, useScrollWheel} from '@vue-aria/interactions';
...
export function useNumberField(props: AriaNumberFieldProps, state: NumberFieldState, inputRef: RefObject<HTMLInputElement | null>): NumberFieldAria {
  ...
  const stringFormatter = useLocalizedStringFormatter(intlMessages, '@vue-aria/numberfield');
