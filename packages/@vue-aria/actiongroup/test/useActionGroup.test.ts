...
import {useActionGroup} from '../src/useActionGroup';
...
vi.mock('@vue-aria/utils', async () => {
  ...
  return {
    ...actual,
    useLayoutEffect: (effect: React.EffectCallback, deps?: React.DependencyList) => React.useLayoutEffect(effect, deps)
  };
});

describe('useActionGroup', function () {
  let renderActionGroupHook = (props: any) => {
