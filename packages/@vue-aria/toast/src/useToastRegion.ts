...
import {AriaLabelingProps, DOMAttributes, FocusableElement, RefObject} from '@vue-types/shared';
import {focusWithoutScrolling, getEventTarget, mergeProps, useLayoutEffect} from '@vue-aria/utils';
import {getInteractionModality, useFocusWithin, useHover} from '@vue-aria/interactions';
// @ts-ignore
import intlMessages from '../intl/*.json';
import {ToastState} from '@vue-stately/toast';
...
export function useToastRegion<T>(props: AriaToastRegionProps, state: ToastState<T>, ref: RefObject<HTMLElement | null>): ToastRegionAria {
  let stringFormatter = useLocalizedStringFormatter(intlMessages, '@vue-aria/toast');
