...
import {AriaGridListItemOptions, GridListItemAria, useGridListItem} from '@vue-aria/gridlist';
import {DOMAttributes, FocusableElement, Node, RefObject} from '@vue-types/shared';
// @ts-ignore
...
export function useTreeItem<T>(props: AriaTreeItemOptions, state: TreeState<T>, ref: RefObject<FocusableElement | null>): TreeItemAria {
  ...
  let stringFormatter = useLocalizedStringFormatter(intlMessages, '@vue-aria/tree');
