...
import {DOMAttributes, FocusableElement, LongPressEvent} from '@vue-types/shared';
import {focusWithoutScrolling, getOwnerDocument, mergeProps, useDescription, useGlobalListeners} from '@vue-aria/utils';
