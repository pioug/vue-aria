...
import {getActiveElement, getEventTarget, getOwnerDocument, getOwnerWindow, isMac, isVirtualClick, openLink} from '@vue-aria/utils';
import {ignoreFocusEvent} from './utils';
import {PointerType} from '@vue-types/shared';
