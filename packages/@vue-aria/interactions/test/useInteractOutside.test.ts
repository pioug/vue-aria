...
function Example(props: any) {
  ...
  return React.createElement('div', {ref, 'data-testid': 'example'}, 'test');
}

function pointerEvent(type: string, opts: Record<string, unknown> = {}) {
...
describe('useInteractOutside', function () {
  describe('pointer events', function () {
    ...
    it('should fire interact outside events based on pointer events', function () {
      let onInteractOutside = vi.fn();
      let res = render(React.createElement(Example, {onInteractOutside}));
    ...
    it('should only listen for the left mouse button', function () {
      let onInteractOutside = vi.fn();
      render(React.createElement(Example, {onInteractOutside}));
  ...
  describe('touch events', function () {
    it('should fire interact outside events based on touch events', function () {
      let onInteractOutside = vi.fn();
      let res = render(React.createElement(Example, {onInteractOutside}));
  ...
  describe('disable interact outside events', function () {
    it('does not handle pointer events if disabled', function () {
      let onInteractOutside = vi.fn();
      render(React.createElement(Example, {isDisabled: true, onInteractOutside}));
