...
describe('useLabel hook', () => {
  let renderLabelHook = (labelProps: any) => {
  ...
  it('should return props for visible label', () => {
    ...
    expect((labelProps as any).htmlFor).toBe(fieldProps.id);
