...
import {chain, getActiveElement, getEventTarget, isCtrlKeyPressed, mergeProps, openLink, useId, useRouter} from '@vue-aria/utils';
import {DOMAttributes, DOMProps, FocusableElement, Key, LongPressEvent, PointerType, PressEvent, RefObject} from '@vue-types/shared';
import {focusSafely, PressHookProps, useLongPress, usePress} from '@vue-aria/interactions';
