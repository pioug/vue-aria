...
import {DatePickerProps, DateValue, Granularity, TimeValue} from '@vue-types/datepicker';
// @ts-ignore
import i18nMessages from '../intl/*.json';
import {LocalizedStringDictionary, LocalizedStringFormatter} from '@internationalized/string';
import {mergeValidation, VALID_VALIDITY_STATE} from '@vue-stately/form';
import {RangeValue, ValidationResult} from '@vue-types/shared';
...
export function getValidationResult(
  ...
  if (isInvalid) {
    ...
    let strings = LocalizedStringDictionary.getGlobalDictionaryForPackage('@vue-stately/datepicker') || dictionary;
