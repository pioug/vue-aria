...
import {DateRange, DateRangePickerProps, DateValue, Granularity, MappedDateValue, TimeValue} from '@vue-types/datepicker';
...
import {RangeValue, ValidationState} from '@vue-types/shared';
