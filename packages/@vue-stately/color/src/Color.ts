...
import {clamp, toFixedNumber} from '@vue-stately/utils';
import {ColorAxes, ColorChannel, ColorChannelRange, ColorFormat, ColorSpace, Color as IColor} from '@vue-types/color';
// @ts-ignore
...
abstract class Color implements IColor {
  ...
  getChannelName(channel: ColorChannel, locale: string) {
    let strings = LocalizedStringDictionary.getGlobalDictionaryForPackage('@vue-stately/color') || dictionary;
