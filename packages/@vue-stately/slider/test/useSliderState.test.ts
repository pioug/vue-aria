...
describe('useSliderState', function () {
  let numberFormatter = new Intl.NumberFormat('en-US', {});

  it('should allow setting and reading values, percentages, and labels', function () {
    let formatOptions = {
      style: 'currency',
      currency: 'USD'
    };
    let currencyFormatter = new Intl.NumberFormat('en-US', formatOptions);
  ...
  it('should enforce maxValue and minValue for multiple thumbs', function () {
    let result = renderHook(() => useSliderState({
  ...
  it('should round values to nearest step with two thumbs', function () {
    let result = renderHook(() => useSliderState({
      minValue: 1,
      maxValue: 15,
      step: 2.5,
  ...
  it('should round values to nearest step with three thumbs', function () {
    let result = renderHook(() => useSliderState({
      minValue: 1,
      maxValue: 15,
      step: 2.5,
  ...
  it('should call onChange and onChangeEnd appropriately', function () {
  ...
  it('should not call onChange and onChangeEnd if not being moved', function () {
    let onChangeEndSpy = vi.fn();
    let onChangeSpy = vi.fn();
    let result = renderHook(() => useSliderState({
      onChangeEnd: onChangeEndSpy,
