...
import {
  ...
  type SpectrumMeterProps,
} from "@vue-spectrum/meter";
import { useProviderProps } from "@vue-spectrum/provider";

export interface S2MeterProps extends SpectrumMeterProps {}
  ...
  setup(props, { attrs }) {
    const forwardedProps = computed(() => {
      ...
      return useProviderProps({
        ...attrsRecord,
        UNSAFE_className: clsx("s2-Meter", attrsClassName, props.UNSAFE_className),
        UNSAFE_style: {
          ...(attrsStyle ?? {}),
          ...(props.UNSAFE_style ?? {}),
        },
    ...
    return () => h(SpectrumMeter, forwardedProps.value as Record<string, unknown>);
  },
});
