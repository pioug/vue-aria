...
import {
  ...
  type SpectrumStatusLightProps,
} from "@vue-spectrum/statuslight";
import { useProviderProps } from "@vue-spectrum/provider";

export interface S2StatusLightProps extends SpectrumStatusLightProps {}
...
export const StatusLight = defineComponent({
  ...
  setup(props, { attrs, slots }) {
    ...
    return () =>
      h(SpectrumStatusLight, forwardedProps.value as Record<string, unknown>, {
