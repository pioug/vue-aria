...
import {
  ...
  type SpectrumRadioGroupProps,
} from "@vue-spectrum/radio";
import { useProviderProps } from "@vue-spectrum/provider";

export interface S2RadioGroupProps extends SpectrumRadioGroupProps {}
...
export const RadioGroup = defineComponent({
  ...
  setup(props, { attrs, slots }) {
    ...
    return () =>
      h(SpectrumRadioGroup, forwardedProps.value as Record<string, unknown>, {
