...
export {
  ...
  ColorArea as S2ColorArea,
  ColorField as S2ColorField,
  ColorSlider as S2ColorSlider,
  ColorSwatch as S2ColorSwatch,
  ColorSwatchPicker as S2ColorSwatchPicker,
  ColorWheel as S2ColorWheel,
  ...
  useDialogContainer as useS2DialogContainer,
...
export type {
  ...
  SpectrumPickerItemProps,
  SpectrumPickerProps,
  SpectrumPickerSectionProps,
