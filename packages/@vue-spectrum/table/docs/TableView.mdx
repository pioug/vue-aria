...
> **Port Status**
> - Status: `complete`
> - Test parity: `8/8 (100.0%)`
> - Snapshot parity: `0/0 (100.0%)`
> - Docs completion: `0/0 (100.0%)`
> - Baseline SHA: `1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1`
> - Deviations: `yes`
> - Upstream reference: <https://github.com/adobe/react-spectrum/tree/1a2b8f860ef2cee6aa579aa6b5e7032ca3be1cb1/packages/@react-spectrum/table>
<!-- PORT_STATUS_END -->
...
This example performs client side sorting by passing a `sort` function to the [useAsyncList](react-aria:useAsyncList.html) hook.
