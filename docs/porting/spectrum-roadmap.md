...
- Display/status package progress: `@vue-spectrum/divider`, `@vue-spectrum/well`, `@vue-spectrum/statuslight`, and `@vue-spectrum/badge` are now complete.
...
- Display/status packages: `4 / 10` completed.
