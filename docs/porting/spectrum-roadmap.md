...
2. Continue expanding the `s2` package from infrastructure baseline into broader component-surface parity, starting with shared provider/context and high-usage control primitives.
