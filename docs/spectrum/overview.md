...
- `@vue-spectrum/menu` (in progress): menu primitives (`Menu`, `MenuSection`, `MenuItem`, `MenuTrigger`, `ActionMenu`) with baseline trigger/menu interaction, section-grouping support, and selection behavior
