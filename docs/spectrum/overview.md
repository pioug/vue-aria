...
- `@vue-spectrum/picker` (in progress): picker primitives (`Picker`, `PickerItem`, `PickerSection`) with baseline trigger/listbox interaction, trigger-anchored placement support, keyboard navigation, controlled/uncontrolled selection behavior, and static slot composition support
