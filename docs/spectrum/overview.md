...
- `@vue-spectrum/actionbar` (in progress): action-bar primitives (`ActionBar`, `ActionBarItem`, `ActionBarContainer`) with baseline selected-count rendering, clear-selection/action wiring, live selection announcements, focus-restore on close, and static slot composition support
