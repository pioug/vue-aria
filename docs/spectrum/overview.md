...
- `@vue-spectrum/menu` (in progress): menu primitives (`Menu`, `MenuSection`, `MenuItem`, `SubmenuTrigger`, `MenuTrigger`, `ActionMenu`) with baseline trigger/menu interaction, section-grouping support, submenu trigger behavior, and selection behavior
