...
- `@vue-spectrum/s2` (in progress): early S2 infrastructure baseline with shared utility exports (`pressScale`, `isDocsEnv`) prior to full component-surface migration
