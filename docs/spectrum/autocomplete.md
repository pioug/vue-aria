...
- Loading indicators, empty async no-results copy, and scroll-bottom `onLoadMore` behavior are included for async suggestion lists, with locale-aware loading/no-results labels.
