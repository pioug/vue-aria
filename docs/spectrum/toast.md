...
- Action button behavior, close-button behavior, timeout behavior, event interception, and programmatic close behavior (via returned close callbacks from `ToastQueue.*`) are covered by starter tests.
